...
function hessianPowermethodRNN(inputs,targets,param,gradParam, delta, model) 
    local maxIter = 50
...
function negativePowermethodRNN(inputs,targets,param,gradParam, delta, maxEigValH, model)
    local maxIter = 50
    local acc_threshold = .2
    local crit = nn.ClassNLLCriterion()
    local criterion = nn.SequencerCriterion(crit)
...
function lanczosRNN(inputs,targets,param,gradParam, delta, model) 
    local maxIter = 50
    local acc_threshold = .2
    local crit = nn.ClassNLLCriterion()
    local criterion = nn.SequencerCriterion(crit)
...
function negativeLanczosRNN(inputs,targets,param,gradParam, delta, maxEigValH, model)
    local maxIter = 50
    local acc_threshold = .2
    local crit = nn.ClassNLLCriterion()
    local criterion = nn.SequencerCriterion(crit)
